...
function car(make, model, year) {
   this.make = make;
   this.model = model;  //this is a constructor
   this.year = year;
}

var myCar = new car("Citroen", "C5", "2014"); //assign propety
var myOtherCar = new car("Dodge", "Camry", 1998);

alert(myCar.model);  //find object
